      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              je suis à la recherche d’une freelance pour développer mes valeurs
              et mes expériences dans le but de servir les besoins des
              utilisateurs.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>Anketa-Bas, Toliara de Madagascar </p>
              <p>herinirikonsylvestre@gmail.com </p>
              <p>+261 34 80 103 47 | +261 32 68 200 71 </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 HERINIRIKO Nomenjanahary Sylvestre .
          </p>
