        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Ingénieur en informatique polyvalent et consultant IT, spécialisé
              en développement web, administration système et réseau, ainsi
              qu’en cybersécurité.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p>heriniaina.roiall@gmail.com </p>
